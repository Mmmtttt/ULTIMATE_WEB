...
- Desktop and Android releases use the `external` plugin mode. Plugin code is installed separately and dependencies are provided by the resident dependency pool.
