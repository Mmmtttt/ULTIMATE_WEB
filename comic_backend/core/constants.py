...
_DYNAMIC_JSON_FILES = {
    ...
    "READING_HISTORY_JSON_FILE": "reading_history_database.json",
    "LAN_TRANSFER_JSON_FILE": "lan_transfer_database.json",
...
READING_HISTORY_JSON_FILE = _DynamicJsonPathProxy(_DYNAMIC_JSON_FILES["READING_HISTORY_JSON_FILE"])
LAN_TRANSFER_JSON_FILE = _DynamicJsonPathProxy(_DYNAMIC_JSON_FILES["LAN_TRANSFER_JSON_FILE"])
